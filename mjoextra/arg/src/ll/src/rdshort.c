/*
 ...
 and related or neighboring rights to this file (rdshort.c).
...
static int
  _mjo_ll_read_option_short(enum mjo_status *const o_status,
...
extern int
  mjo_ll_read_option_short(enum mjo_status *const o_status,
                           mjo_vector_t *const io_vector,
                           mjo_lexer_t const io_lexer,
  ...
  do
    {
      ...
      l_rc
        = _mjo_ll_read_option_short(&l_status, io_vector, io_lexer, io_stream);
    }
  while (0);
